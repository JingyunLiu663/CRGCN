...
def cold_start_sample():
    ...
    """
    with open('test_dict.txt', encoding='utf-8') as f, open('validation_dict.txt', encoding='utf-8') as val, open('buy_dict.txt', encoding='utf-8') as t:
        data = json.load(f)
    ...
    with open('test_dict.txt', 'w') as w:
        w.write(json.dumps(test_dict))
    with open('buy_dict.txt', 'w') as w:
        w.write(json.dumps(buy_data))
    with open('validation_dict.txt', 'w') as w:
